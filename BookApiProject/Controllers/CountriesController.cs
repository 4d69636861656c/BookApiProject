...
namespace BookApiProject.Controllers
{
    ...
    public class CountriesController : Controller
    {
        ...
        //api/countries
        [HttpPost]
        [ProducesResponseType(201, Type = typeof(Country))] // Object created.
        [ProducesResponseType(400)]
        ...
        public IActionResult CreateCountry([FromBody]Country countryToCreate)
        {
            ...
            if (country != null)
            {
                ModelState.AddModelError("", $"The country {countryToCreate.Name} already exists!");
        ...
        public IActionResult DeleteCountry(int countryId)
        {
            ...
            if (_countryRepository.GetAuthorsFromACountry(countryId).Count() > 0)
            {
                ...
                return StatusCode(409, ModelState); // Conflict with the foreign key in the database.
            }
