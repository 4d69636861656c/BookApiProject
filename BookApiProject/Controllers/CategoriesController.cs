...
namespace BookApiProject.Controllers
{
    ...
    public class CategoriesController : Controller
    {
        ...
        public IActionResult GetAllCategoriesOfABook(int bookId)
        {
            ...
            var categories = _categoryRepository.GetAllCategoriesOfABook(bookId).ToList();
        ...
        public IActionResult GetAllBooksForCategory(int categoryId)
        {
            ...
            var books = _categoryRepository.GetAllBooksForCategory(categoryId).ToList();
        ...
        public IActionResult CreateCategory([FromBody]Category categoryToCreate)
        {
            ...
            if (category != null)
            {
                ModelState.AddModelError("", $"The category {categoryToCreate.Name} already exists!");
        ...
        public IActionResult UpdateCategory(int categoryId, [FromBody] Category updatedCategoryInfo)
        {
            ...
            {
                ModelState.AddModelError("", $"Something went wrong updating category {updatedCategoryInfo.Name}!");
                return StatusCode(500, ModelState);
            }
        ...
        public IActionResult DeleteCategory(int categoryId)
        {
            ...
            {
                ModelState.AddModelError("", $"Category {categoryToDelete.Name} cannot be deleted because it is used by at least one book object in the database!");
